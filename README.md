...
## Deployment
In order to deploy metrics-server in your kubernetes master machine clone https://github.com/rbasha786/Kubernetes_metrics_server.git  and run the following command from
